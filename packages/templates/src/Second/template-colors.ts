...
export const CELL_STYLES: Partial<Record<Colors, string>> = {
...
export const HOVER_CELL_STYLES: Partial<Record<Colors, string>> = {
...
export const FILLED_BUTTON_STYLES: Partial<Record<Colors, string>> = {
